...
class ScreeningPage(al.Page):
    ...
    def on_exp_access(self):
        ...
        self.append(al.Text(self.content["screening_info"], width="full"))
        ...
        if self.email_screening:
            ...
            self.append(al.Text(self.content["data_protection_info"], width="full"))

    def do_screening(self):
        if self.email_screening:
            if not self.screening_email.validate_data(silent=True):
                return
